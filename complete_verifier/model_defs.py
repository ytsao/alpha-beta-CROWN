...
class ORCA_mnist_7x200_best(nn.Module):
    def __init__(self):
        super(ORCA_mnist_7x200_best, self).__init__()
        ...
        self.fc6 = nn.Linear(in_features=200, out_features=200)
        self.fc7 = nn.Linear(in_features=200, out_features=200)
        self.fc8 = nn.Linear(in_features=200, out_features=10)
